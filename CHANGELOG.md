...
- **Async Event Handlers**: Fixed support for `async def` event handlers in WebSocket consumer. Async handlers are now properly awaited without wrapping in `sync_to_async`. ([#63](https://github.com/djust-org/djust/pull/63))
