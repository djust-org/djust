- **1.3.0rc1 spent ~20% more server CPU per LiveView frame than 1.2.1
  ...
  takes 0.086 ms instead of 1.0 ms, and Snake Arena's server CPU per delivered
  frame is back at 1.2.1's level (2.97 ms vs 2.96 ms; main was 3.59 ms).
  10 regression cases in `python/djust/tests/test_parameter_metadata_cache_3075.py`,
