...
Loaded-template compilation errors retain the failing file and token span, including custom-tag exceptions. Runtime exception attribution and Django node metadata remain incomplete.
