...
### 🔄 State Management
- **[State Management API](state-management/STATE_MANAGEMENT_API.md)** - Complete decorator reference — note @debounce/@throttle/@optimistic are inert (#2656) (@debounce, @throttle, @loading, @cache, @client_state, @optimistic, DraftModeMixin)
