...
### 🔄 State Management
- **[State Management API](state-management/STATE_MANAGEMENT_API.md)** - Complete decorator reference (@debounce, @throttle, @cache, @loading, DraftModeMixin, and the inert @optimistic / @client_state — see #2699)
