...
See [error codes](../guides/error-codes.md) if you get a `T002` / `T012` (not `T001`, which is the deprecated `@click` syntax check)-family system-check warning about missing template attributes.
