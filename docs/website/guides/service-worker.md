...
When the user hits the back or forward button, the SW serves a cached HTML
snapshot of the destination URL **immediately**,
...
DJUST_VDOM_CACHE_TTL_SECONDS = 1800        # default — entries expire after 30 min
