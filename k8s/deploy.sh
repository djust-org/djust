...
# djust Deployment Script
# This script deploys djust to Kubernetes

NAMESPACE="djust"
IMAGE_NAME="ghcr.io/johnrtipton/djust:latest"
DOMAIN="djust.k8.trylinux.org"

echo "======================================"
echo "djust Deployment"
echo "======================================"
...
kubectl rollout restart deployment/djust -n $NAMESPACE
...
kubectl rollout status deployment/djust -n $NAMESPACE
...
echo ""
echo "View logs with:"
echo "kubectl logs -f deployment/djust -n $NAMESPACE"
echo ""
