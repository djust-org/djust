...
| **Standalone `{% live_input %}` template tag** | — | — | **Not started (#650; restart per #652 design notes)** | **v0.4.1** |
...
| **`djust_audit` declarative permissions (`--permissions`)** | — | — | **Not started (#657)** | **v0.4.1** |
| **`djust_audit` ASGI stack + config static checks** | — | — | **Not started (#659)** | **v0.4.1** |
| **`djust_audit` AST-based anti-pattern scanner** | — | — | **Not started (#660)** | **v0.4.1** |
| **`djust_audit --live` runtime header probe** | — | — | **Not started (#661)** | **v0.4.1** |
