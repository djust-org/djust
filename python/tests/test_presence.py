...
class TestPresenceManager:
    ...
    def test_presence_group_name(self):
        ...
        assert (
            PresenceManager.presence_group_name("chat:{room_id}") == "djust_presence_chat_room_id"
        )
...
class TestPresenceMixin:
    ...
    def test_broadcast_to_presence(
        self, mock_async_to_sync, mock_get_channel_layer, user, request_factory
    ):
...
class TestLiveCursorMixin:
    ...
    @patch("djust.presence.get_channel_layer")
    @patch("djust.presence.async_to_sync")
    def test_untrack_presence_removes_cursor(
        self, mock_async_to_sync, mock_get_channel_layer, user, request_factory
    ):
