"""
Component registry for Django Rust Live.
...
def register_component(name: str, component_class: Type[LiveComponent]):
    ...
    Example:
        from django_rust_live.components import register_component
...
def get_component(name: str) -> Optional[Type[LiveComponent]]:
    ...
    Example:
        from django_rust_live.components import get_component
...
def list_components() -> Dict[str, Type[LiveComponent]]:
    ...
    Example:
        from django_rust_live.components import list_components
...
def unregister_component(name: str) -> bool:
    ...
    Example:
        from django_rust_live.components import unregister_component
