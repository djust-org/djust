"""
Table component for Django Rust Live.
...
class TableComponent(LiveComponent):
    ...
    def _render_tailwind(self) -> str:
        ...
        for col in self.columns:
            ...
            th_class = 'px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'
        ...
        for idx, row in enumerate(self.rows):
            ...
            for col in self.columns:
                ...
                # Badge rendering
                if col.get('badge'):
                    badge_variant = 'bg-green-100 text-green-800' if value == 'active' else 'bg-gray-100 text-gray-800'
