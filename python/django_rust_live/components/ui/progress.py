"""
Progress component for Django Rust Live.
...
class ProgressComponent(LiveComponent):
    ...
    def mount(self, **kwargs):
        ...
        self.variant = kwargs.get('variant', 'primary')  # primary, secondary, success, danger, warning, info
    ...
    def _render_tailwind(self) -> str:
        ...
        if self.animated:
            html = f'<style>@keyframes shimmer {{0% {{background-position: -100% 0;}} 100% {{background-position: 100% 0;}}}}</style>' + html
