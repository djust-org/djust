"""
React component integration for Django Rust Live

This module provides a registry and integration system for using React components
within Django Rust Live templates with server-side rendering and client-side hydration.
"""
...
class ReactComponentRegistry:
    """
    Registry for React components that can be used in Django Rust Live templates.
