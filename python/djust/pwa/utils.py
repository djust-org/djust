...
def merge_offline_changes(server_data: Dict, offline_changes: Dict, strategy: str = 'client_wins') -> Dict[str, Any]:
    """
...
class PWAHealthMonitor:
    ...
    def _get_recommendations(self) -> List[str]:
        ...
        if self.metrics['average_sync_time'] > 30:
            recommendations.append('Sync times are high, consider reducing data size or using compression')
