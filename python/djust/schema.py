...
DIRECTIVES: List[Dict[str, Any]] = [
    ...
    },
    {
        "name": "dj-mouseenter",
        "category": "event",
        "description": "Send event when the pointer enters the element. Non-bubbling: entering a child fires neither the parent's dj-mouseleave nor a second dj-mouseenter.",
        "value": "handler_name",
        "dom_event": "mouseenter",
        "example": '<div dj-mouseenter="preview">Hover me</div>',
        "params_sent": ["data-* attributes", "positional args from handler syntax"],
        "modifiers": [],
    },
    {
        "name": "dj-mouseleave",
        "category": "event",
        "description": "Send event when the pointer leaves the element. Non-bubbling: moving into a child element does not fire it.",
        "value": "handler_name",
        "dom_event": "mouseleave",
        "example": '<div dj-mouseenter="preview" dj-mouseleave="hide_preview">Hover me</div>',
        "params_sent": ["data-* attributes", "positional args from handler syntax"],
        "modifiers": [],
    },
    {
