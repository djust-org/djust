...
# Labels on the bright fills (#2996). White on the rust orange, the Django
# greens and the status colours measured 2.1-3.9:1, under WCAG AA's 4.5:1;
# this near-black green ink (#182019) reads at 4.5-7.8:1 on the same fills,
# which keep their hue. Light mode's secondary/accent greens are deepened
# instead (39% -> 32% lightness), so white stays on them at 5.3:1.
INK = ColorScale(128, 14, 11)
