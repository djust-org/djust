...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Generated service worker at: {output_path}")
        )
        ...
        if not os.path.exists(manifest_path):
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Generated manifest at: {manifest_path}")
            )
    ...
    def _generate_service_worker(
        ...
        template_str = '''// djust Service Worker - Generated by `python manage.py generate_sw`
// Version: {{ version }}
