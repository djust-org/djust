...
crosses as ``str(o)`` (#2624). Python's own recursion limit, 1000 — the depth
at which CPython itself refuses to ``repr``/``json.dumps`` a structure, and
well inside the 8 MiB (glibc) / 16 MiB (macOS) stack every real thread has."""
