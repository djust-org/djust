...
```bash
# Run all VDOM tests
cargo test --package django_rust_vdom

# Run only unit tests
cargo test --package django_rust_vdom --lib

# Run only integration tests
cargo test --package django_rust_vdom --test integration_test

# Run specific test
cargo test --package django_rust_vdom test_diff_with_whitespace_text_nodes
```
