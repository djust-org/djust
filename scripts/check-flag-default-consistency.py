...
SITES: dict[str, list[tuple[str, str]]] = {
    ...
    # ADR-027's kill-switch (#2539) was registered here by movement 3 (six
    # prose statements across four files plus two Rust literals) and removed
    # with the flag itself in Step 5 (#2628): a deleted setting has no default
    # to pin.
}
